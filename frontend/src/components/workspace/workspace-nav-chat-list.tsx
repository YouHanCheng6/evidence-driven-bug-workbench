  ...
  return (
    <SidebarGroup className="pt-1">
      <SidebarMenu>
        ...
        <SidebarMenuItem>
          <SidebarMenuButton
            isActive={pathname.startsWith("/workspace/bugs")}
            asChild
          >
            <Link className="text-muted-foreground" href="/workspace/bugs">
              <BugIcon />
              <span>{t.sidebar.bugWorkbench}</span>
            </Link>
          </SidebarMenuButton>
        </SidebarMenuItem>
        <SidebarMenuItem>
          <SidebarMenuButton
            isActive={pathname.startsWith("/workspace/feishu-conversations")}
            asChild
          >
            <Link
              className="text-muted-foreground"
              href="/workspace/feishu-conversations"
            >
              <MessageSquareMore />
              <span>{t.sidebar.feishuConversations}</span>
            </Link>
          </SidebarMenuButton>
        </SidebarMenuItem>
        <SidebarMenuItem>
