...
class AgentConfig(BaseModel):
    ...
    # Operator-controlled opt-in for persistent skill creation.  This is kept
    # per agent so a broad personal assistant can evolve without exposing the
    # mutation surface to every custom agent in the deployment.
