...
from deerflow.config.bug_analysis_config import BugAnalysisConfig
...
class AppConfig(BaseModel):
    ...
    bug_analysis: BugAnalysisConfig = Field(
        default_factory=BugAnalysisConfig,
        description="Bug Workbench investigation-engine and independent-review configuration.",
    )
